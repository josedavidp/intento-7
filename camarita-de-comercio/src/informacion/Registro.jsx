            ...
            <div className="min-h-screen py-40" style={{ backgroundColor: 'white' }}>
                <div className="container mx-auto">
                    <div className="flex flex-col lg:flex-row w-10/12 lg:w-8/12 bg-blue rounded-xl mx-auto shadow-lg overflow-hidden">
                        <div className="w-full lg:w-1/2 flex flex-col items-center justify-start p-5 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${ImgIngresar})` }}>
                        </div>
                        <div className="w-full lg:w-1/2 py-16 px-12">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="grid grid-cols-2 gap-5">
                                    <input type="text" placeholder="Nombres" className="border border-gray py-1 px-2" value={name} onChange={(e) => setFirstName(e.target.value)} />
                                    <input type="text" placeholder="Apellidos" className="border border-gray py-1 px-2" value={lastname} onChange={(e) => setSurname(e.target.value)} />
                                </div>
                                <div className="mt-5">
                                ...
                                <div className="mt-5">
                                    <input type="password" placeholder="Clave" className="border border-gray py-1 px-2 w-full" value={password} onChange={(e) => setPassword(e.target.value)} />
                                </div>
                                <div className="mt-5">
                                    <input type="password" placeholder="Confirmar Clave" className="border border-gray py-1 px-2 w-full" value={password2} onChange={(e) => setConfirmPassword(e.target.value)} />
                                </div>
                                <div className="mt-5">
                                    <input type="checkbox" className="border border-gray" checked={aceptoTerminos} onChange={handleCheckbox} />
                    ...
                    Acepto los <a href="#" className="text-yellow font-semibold">Terminos y condiciones</a> &  <a href="#" className="text-yellow font-semibold">Politica de privacidad</a>
                                ...
                                <div className="mt-5">
                                    <button type="submit" className={`w-full bg-yellow py-3 text-center text-blue ${!aceptoTerminos ? 'opacity-50 cursor-not-allowed' : ''}`} onClick={handleSubmit} disabled={!aceptoTerminos}>
                                        Registrate
                                    </button>
                                </div>
                            </form>
